...
/***
 * Tests updating teacher's surname
 */ 

public class UpdateTeacherSurnameTest extends FunctionalTest{
	
	@Test
	public void updateTeacherSurname() throws InterruptedException {
		...
		// fill form data
		updateTeacherPage.updateTeacherSurname("Perry");
